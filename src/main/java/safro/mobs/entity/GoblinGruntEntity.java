...
public class GoblinGruntEntity extends HostileEntity implements SimpleAnimatable {
    ...
    public static DefaultAttributeContainer.Builder createGoblinGruntAttributes() {
        return MobEntity.createMobAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH, 80.0D).add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.25D).add(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE, 1.0D).add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 12.0D);
    }
